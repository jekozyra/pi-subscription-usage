  ...
  const usageStatus = (): WeeklySubscriptionUsageStatus => {
    ...
    return observation.kind === "none"
      ...
      : {
          ...
          ...(observation.usage.sessionUsedPercent === undefined
            ? {}
            : { sessionUsedPercent: observation.usage.sessionUsedPercent }),
          ...(observation.usage.sessionResetsAtMs === undefined
            ? {}
            : { sessionWindowResetsAtMs: observation.usage.sessionResetsAtMs }),
        };
  };
